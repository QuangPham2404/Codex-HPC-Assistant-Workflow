...
1. Clone or copy this package into the new project repository. Use command `npx degit QuangPham2404/Codex-HPC-Assistant-Workflow/workflow_v1 my-project/workflow` to download the preserved v1 package as a directory rather than a git-tracked repo.
